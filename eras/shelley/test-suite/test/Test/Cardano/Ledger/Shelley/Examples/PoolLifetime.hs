...
initUTxO :: Cr.PureGenCrypto c => UTxO (ShelleyEra c)
initUTxO =
  genesisCoins
    genesisId
...
initStPoolLifetime :: forall c. Cr.PureGenCrypto c => ChainState (ShelleyEra c)
...
txbodyEx1 :: Cr.PureGenCrypto c => ShelleyTxBody (ShelleyEra c)
txbodyEx1 =
  ShelleyTxBody
...
txbodyEx2 :: forall c. Cr.PureGenCrypto c => ShelleyTxBody (ShelleyEra c)
txbodyEx2 =
  ShelleyTxBody
...
snapEx3 :: Cr.PureGenCrypto c => EB.SnapShot c
snapEx3 =
  EB.SnapShot
    { EB.ssStake =
        mkStake
...
txbodyEx4 :: forall c. Cr.PureGenCrypto c => ShelleyTxBody (ShelleyEra c)
txbodyEx4 =
  ShelleyTxBody
...
snapEx5 :: forall c. Cr.PureGenCrypto c => EB.SnapShot c
snapEx5 =
  EB.SnapShot
    { EB.ssStake =
        mkStake
...
pdEx5 :: forall c. Cr.PureGenCrypto c => PoolDistr c
pdEx5 =
  PoolDistr $
    Map.singleton
...
nonMyopicEx8 :: forall c. Cr.PureGenCrypto c => NonMyopic c
nonMyopicEx8 =
  NonMyopic
...
rewardUpdateEx8 :: forall c. Cr.PureGenCrypto c => RewardUpdate c
rewardUpdateEx8 =
  RewardUpdate
    { deltaT = deltaT8
    , deltaR = deltaR8
...
snapEx9 :: forall c. Cr.PureGenCrypto c => EB.SnapShot c
snapEx9 =
  snapEx5
    { EB.ssStake =
        mkStake
...
txbodyEx10 :: Cr.PureGenCrypto c => ShelleyTxBody (ShelleyEra c)
txbodyEx10 =
  ShelleyTxBody
...
txbodyEx11 :: forall c. Cr.PureGenCrypto c => ShelleyTxBody (ShelleyEra c)
txbodyEx11 =
  ShelleyTxBody
...
alicePerfEx11 :: forall c. Cr.PureGenCrypto c => Likelihood
...
nonMyopicEx11 :: forall c. Cr.PureGenCrypto c => NonMyopic c
nonMyopicEx11 =
  NonMyopic
...
rewardUpdateEx11 :: forall c. Cr.PureGenCrypto c => RewardUpdate c
rewardUpdateEx11 =
  RewardUpdate
    { deltaT = DeltaCoin 0
    , deltaR = DeltaCoin 0
...
snapEx12 :: forall c. Cr.PureGenCrypto c => EB.SnapShot c
snapEx12 =
  snapEx9
    { EB.ssStake =
        mkStake
